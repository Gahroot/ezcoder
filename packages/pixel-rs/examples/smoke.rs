...
use ez_pixel::{capture, init_pixel, PixelOptions};

fn main() {
    let key = env::var("EZCODER_PIXEL_KEY").expect("set EZCODER_PIXEL_KEY=pk_live_...");
    ...
    ez_pixel::flush(Duration::from_secs(2));

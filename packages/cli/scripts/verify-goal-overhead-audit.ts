...
const DEFAULT_REPORT_PATH = "packages/cli/docs/goal-system-efficiency-audit.md";
const DEFAULT_INVENTORY_PATH = "packages/cli/docs/goal-system-overhead-inventory.json";
const PACKAGE_PREFIX = "packages/cli/";
...
const requiredReportNeedles = [
  ...
  "packages/cli/src/ui/prompt-routing.ts",
  "packages/cli/src/system-prompt.ts",
  "packages/cli/src/core/goal-controller.ts",
  "packages/cli/src/core/goal-store.ts",
  "packages/cli/src/core/goal-worker.ts",
  "packages/cli/src/core/goal-overhead-harness.ts",
  "Stage count",
  "Prompt chars",

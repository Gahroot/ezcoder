 ...
 * Run:
 *   pnpm --filter @prestyj/cli verify:repomap:cold-start
 */
...
const GGCODER_CHANGED_FILES = [
  ...
  "packages/cli/scripts/verify-repomap-cold-start.js",
...
async function main() {
  ...
  record(
    ...
    paths.indexOf("packages/cli/src/ui/App.tsx") > 5 &&
      paths.indexOf("packages/cli/src/cli.ts") > 5,
    paths.slice(0, 8).join("\n"),
  );

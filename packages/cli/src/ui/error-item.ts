...
const EZCODER_BUG_REPORT_URL = "github.com/Gahroot/ezcoder/issues";
 ...
 * "Should I retry, or is this an EZ Coder bug to report?"
 */
export function toErrorItem(err: unknown, id: string, contextPrefix?: string): ErrorItem {
  ...
  const guidance =
    f.source === "ezcoder"
      ? `This looks like an EZ Coder bug — please send it to the dev at ${EZCODER_BUG_REPORT_URL}.`
      : f.guidance;

    ...
    const text = segmentsToPlainText(
      buildToolGroupSummary(
        [
          {
            name: "read",
            args: { file_path: "packages/cli/src/ui/App.tsx" },
            status: "done",
          },
          {
            name: "read",
            args: { file_path: "packages/cli/src/ui/terminal-history.ts" },
            status: "done",
          },
          {
            name: "read",
            args: { file_path: "packages/cli/src/ui/tool-group-summary.ts" },
            status: "done",
          },
        ],
        true,

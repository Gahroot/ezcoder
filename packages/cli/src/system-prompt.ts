...
<<<<<<< HEAD:packages/cli/src/system-prompt.ts
...
<<<<<<< HEAD:packages/cli/src/system-prompt.ts
      `- **skill**: Invoke a skill by name to get specialized instructions for a task. Skills are defined in \`.ezcoder/skills/\` as markdown files. Use this tool when a task matches an available skill.\n` +
...
>>>>>>> upstream/main:packages/ggcoder/src/system-prompt.ts

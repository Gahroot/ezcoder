...
import type { Message, Provider, Usage } from "@prestyj/ai";
import type { TransformContextOptions } from "@prestyj/agent";
 ...
 * transient sessions (Nolan chat/autopilot and subagent spawns). */

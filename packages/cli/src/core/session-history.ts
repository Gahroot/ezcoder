import type { Message, MessageProvenance } from "@prestyj/ai";
 ...
 * dropped rather than replayed at EOF, which bunched old Nolan all-clear bubbles
 * at the bottom. Exact duplicate payloads are deduped.
 */

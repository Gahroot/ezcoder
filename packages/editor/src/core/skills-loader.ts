 ...
 *   → project (<cwd>/.ezcoder/editor-skills/*.md)
 *   → user    (~/.ezcoder/editor-skills/*.md)
 *
...
export function discoverSkills(opts: DiscoverSkillsOptions): SkillSource[] {
  ...
  const projectDir = resolvePath(opts.cwd, ".ezcoder/editor-skills");
  const userDir = resolvePath(home, ".ezcoder/editor-skills");

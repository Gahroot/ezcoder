...
/**
 * Minimal session persistence for `ezeditor continue`.
 *
 * Each TUI run writes its rolling message buffer to ~/.ezcoder/editor/last.json
 * after every turn. `ezeditor continue` reads this file and hydrates a new

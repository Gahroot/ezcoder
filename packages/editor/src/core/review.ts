import { Agent, type AgentTool } from "@prestyj/agent";
import type { Usage } from "@prestyj/ai";
...
const REVIEW_SYSTEM = `You are the EZ Editor REVIEWER — a read-only critic of an edit-in-progress.

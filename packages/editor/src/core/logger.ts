 ...
 *
 * Filter a single run: `grep " sid=<id>" ~/.ezcoder/ezeditor.log` once you've
...
/** Default path: `~/.ezcoder/ezeditor.log`. */
export function defaultLogPath(): string {
  return join(homedir(), ".ezcoder", "ezeditor.log");
}

...
import { getModel } from "@prestyj/cli/models";
import type { Provider } from "@prestyj/ai";

/**
 * Welcome banner for ezeditor. Static — printed once into terminal scrollback.
...
// from ezcoder's cool blue/purple so users instantly know which tool they're in.
const GRADIENT = [
  "#fbbf24",
  "#f59e0b",
  "#f97316",

...
public final class EZPixel {
    public static let shared = EZPixel()
    ...
    /// Initialize ez-pixel. Call once at app startup.
    public func initialize(
        projectKey: String,
        ingestUrl: String = EZPixel.DEFAULT_INGEST_URL,
        runtime: String? = nil,
        ...
        defer { lock.unlock() }
        if initialized {
            print("[ez-pixel] already initialized — ignoring")
            return
        }

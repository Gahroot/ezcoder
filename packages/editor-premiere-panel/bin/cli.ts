...
After CEP install:
  1. Quit and restart Premiere Pro
  2. Window menu → Extensions → "EZ Editor"
...
function doInstallUxp(): void {
  ...
  process.stdout.write("  4. Window → UXP Plugins → \"EZ Editor\"\n");
  process.stdout.write("  5. Click Connect, then run: ezeditor --host premiere\n");
}
...
function doInstallCep(): void {
  ...
  process.stdout.write("  1. Quit and restart Premiere Pro\n");
  process.stdout.write("  2. Window → Extensions → \"EZ Editor\"\n");
  process.stdout.write("  3. Run: ezeditor --host premiere\n");
  process.stdout.write(
    chalk.yellow(

/* eslint-disable */
/**
 * EZ Editor UXP plugin entrypoint.
 *
 ...
 * dials out to the ezeditor CLI's localhost WS server, sends a hello
 * frame, and then handles RPC requests on the same connection.
 *
 * Wire protocol (matches PremiereWsBridge in @prestyj/editor):
 *
 ...
 * where the user starts ezeditor *after* opening Premiere.
 */

const { handle } = require("./commands/index.js");

const PRODUCT = "ez-editor-premiere-panel";
const VERSION = "0.2.0";

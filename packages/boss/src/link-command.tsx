    ...
    return (
      <Box flexDirection="column" paddingX={2}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text color={COLORS.textDim}>No ezcoder projects found in ~/.ezcoder/sessions/.</Text>
          <Text color={COLORS.textDim}>
            Run ezcoder in a project at least once, then re-run{" "}
            <Text color={COLORS.accent}>ezboss link</Text>.
          </Text>
          <Box marginTop={1}>
  ...
  if (linked.length === 0) {
    ...
    process.stdout.write(
      chalk.hex(COLORS.textDim)(`Run `) +
        chalk.hex(COLORS.accent)("ezboss") +

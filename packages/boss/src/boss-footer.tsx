...
export function BossFooter({
  ...
  // Context bar — same partial-block precision as ezcoder's Footer.
  const barWidth = 8;
  ...
  const estFull =
    ...
    (updatePending ? 3 + 28 : 0); // " │ Update ready. Restart EZ Boss."
        ...
        {updatePending && (
          <>
            ...
            <Text color={theme.success} bold wrap="truncate">
              {useShortUpdate ? "Update ready" : "Update ready. Restart EZ Boss."}
            </Text>
          </>
        )}
      </Box>

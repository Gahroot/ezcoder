...
/**
 * Boss debug log — mirrors ezcoder's logger pattern so the format is grep-
 * compatible across the framework. Lives at ~/.ezcoder/boss/debug.log; rotates at
 ...
 * fd is set. Generates a per-process session id so concurrent ezboss

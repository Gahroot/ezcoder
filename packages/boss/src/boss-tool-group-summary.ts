...
} from "@prestyj/cli/ui/tool-group-summary";
 ...
 * ezcoder's AGGREGATABLE_TOOLS but scoped to the boss's read-only inspection
...
/**
 * Boss-specific group summary renderers, merged over ezcoder's built-ins by

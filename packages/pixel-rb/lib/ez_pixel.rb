...
# Public API for ez-pixel error tracking.
#
#   require "ez_pixel"
#   EZPixel.init(project_key: ENV["EZCODER_PIXEL_KEY"])
#
module EZPixel
  DEFAULT_INGEST_URL = "https://pixel-server.ngrout70.workers.dev/ingest"
  USER_AGENT = "ez-pixel-ruby/4.3.72"
  ...
  class << self
    ...
    def init(project_key:, ingest_url: DEFAULT_INGEST_URL, runtime: nil)
      ...
      raise "ez-pixel already initialized" if @client

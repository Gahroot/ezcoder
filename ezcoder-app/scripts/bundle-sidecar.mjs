// Bundle the ezcoder app-sidecar into a single self-contained ESM file shipped
...
const NM_ROOTS = [
  ...
  join(repoRoot, "packages", "ai", "node_modules"),
...
async function main() {
  ...
  const ezcoderRoot = join(repoRoot, "packages", "cli");

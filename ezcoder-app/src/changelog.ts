 ...
 * `.ezcoder/commands/release.md` (Track B). Each item is one distinct user-facing
...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Long sessions stay rock solid. I sealed a slow leak that ate system resources every time EZ Coder reopened your archived chats, and background logs in `~/.ezcoder` now tidy up after themselves instead of quietly growing on your disk forever.",
    ],
  },
  {
    version: "0.42.0",
  ...
  },
  {
    ...
    date: "2026-08-06",
    items: [
      "EZ Coder just got dramatically lighter. I used to spin up a private set of background helpers for every single window, so four projects open meant four copies of everything doing identical work. Now they all share, and a four window session on my machine dropped from `3.3 GB` to about `900 MB`. Same speed, same features, far more room for everything else you are running.",
  ...
  },
  {
    ...
    date: "2026-08-03",
    items: [
      "Your phone remote and other `ACP` clients now show a live context meter. I report exactly how full the window is as the conversation moves, so you can see the room you have left instead of guessing. Best part: when EZ Coder compacts a long session, you watch the usage drop on the spot, and a resumed chat shows its context the moment it opens rather than after the first reply.",
    ],
  },
  {
    version: "0.39.0",
    date: "2026-08-03",
    items: [
      "EZ Coder can no longer tell you a check passed when it did not. I taught it to judge every command it runs, so a `--watch` that never finishes, a build that rewrites files, or a `--help` that proves nothing all get rejected as evidence. Only real, finished checks like `tsc --noEmit` count now.",
  ...
  },
  {
    ...
    date: "2026-08-01",
    items: [
      "Your phone remote and other `ACP` clients now know every command EZ Coder can run the instant a session opens. I wired in built-ins plus project favorites like `/commit`, with the exact descriptions and inputs you need, so command pickers are complete without brittle file scanning.",
    ],
  },
  {
    version: "0.37.5",
  ...
  },
  {
    ...
    date: "2026-07-30",
    items: [
      "Big autonomous jobs can now run longer without drowning in their own history. I taught `EZ Coder` to clear away old research and bulky working scraps as it goes, so you get more useful context, fewer interruptions and a steadier finish on massive tasks.",
    ],
  },
  {
    version: "0.37.2",
    date: "2026-07-30",
    items: [
      "EZ Coder now plugs straight into `ACP` editors like `Zed`. Run `ezcoder acp` and you get your real sessions, model controls, thinking levels, plan mode, streaming answers and clean cancellation right inside the tools you already use.",
  ...
  },
  {
    ...
    items: [
      ...
      "A crash no longer eats your work. I now save your session at every step, so if EZ Coder dies mid-task everything it already did is still there when you come back, and it tells you exactly where things stopped.",
  ...
  },
  {
    ...
    date: "2026-07-28",
    items: [
      "Bring your old conversations with you. `/import` pulls a Claude Code, Codex or Cursor thread straight into EZ Coder and you carry on where you left off, full history intact. I tested it on a real `44` message thread and it picked up mid sentence.",
  ...
  },
  {
    ...
    date: "2026-07-28",
    items: [
      "Reopen a chat and everything sits exactly where it happened. Errors, `Nolan` verdicts and plan banners used to pile up at the bottom of long conversations, sometimes `900` messages below where they belong. I went through every one of your saved chats and fixed the lot, old ones included.",
  ...
  },
  {
    ...
    items: [
      ...
      "I stopped writing my own history book. Last release I started keeping notes in `.ezcoder/memory.md`, and being honest with you, it backfired: it repeated what your code already says, and it made me trust my own notes instead of going and checking. It is gone. I read your real code every time now.",
  ...
  },
  {
    ...
    date: "2026-07-23",
    items: [
      "Long builds no longer stall out waiting for you to type `Continue`. I taught EZ Coder to catch runaway tool calls, retry them `2 times`, and keep your conversation moving without losing its place.",
  ...
  },
  {
    ...
    items: [
      ...
      "Updates now show their work. Tap the new `Install` badge and both the footer and home screen turn into live percentage progress, with zero jumping around while EZ Coder downloads the good stuff.",
  ...
  },
  {
    ...
    date: "2026-07-21",
    items: [
      "Every interface EZ Coder builds now starts with accessibility as a hard requirement. I made `WCAG 2.2 AA` and `ADA-aligned` design non-negotiable across keyboard navigation, screen readers, contrast, motion, forms, media, zoom, and complete user flows. Better UI now means more people can actually use it.",
    ],
  },
  {
    version: "0.24.4",
    date: "2026-07-21",
    items: [
      "EZ Coder's `UI skill` just got pickier about color. I taught it to reject the muddy red-on-red and green-on-green `status pills` AI loves to repeat, then choose styling that actually fits your product instead of forcing another template. Your interfaces get cleaner without all looking the same.",
    ],
  },
  {
    version: "0.24.3",
    date: "2026-07-21",
    items: [
      "Interfaces EZ Coder builds just got a serious taste upgrade. I taught the `UI skill` to lock navigation and content to one clean rail, give `dropdowns` proper breathing room, and kill sticky click outlines without sacrificing `keyboard focus`. The tiny details finally behave like they belong together.",
    ],
  },
  {
    version: "0.24.2",
    ...
    items: [
      ...
      "EZ Coder refuses to melt down in the background now. I give the engine `5 retries`, then stop it cleanly, and cap each run's logs at `10 MB` so a bad crash can never spiral into a process or disk-space storm.",
    ],
  },
  {
    version: "0.24.1",
  ...
  },
  {
    ...
    items: [
      ...
      "EZ Coder knows when it is stuck now. I taught it to spot repeating tool cycles up to `5 steps` long, break the pattern once, then stop cleanly and tell you exactly what is blocking it instead of burning time on endless retries.",
      ...
      "Project rules land in the right order every time. I added `AGENTS.override.md`, nearest-folder precedence, a smart `32 KiB` budget, and tougher plan checks so EZ Coder follows the instructions you actually meant without silently losing them.",
    ],
  },
  {
    version: "0.23.7",
  ...
  },
  {
    ...
    date: "2026-07-19",
    items: [
      "When EZ Coder hits a snag, I can see it faster now. I wired in `Error Mom` monitoring so startup failures and unexpected crashes reach me automatically, helping me squash problems before they derail you again.",
    ],
  },
  {
    version: "0.23.4",
  ...
  },
  {
    ...
    date: "2026-07-17",
    items: [
      "Long chats just got another serious efficiency boost. I taught EZ Coder to learn each model's real token footprint, wait until `85%` before compacting, then carry a leaner `8K` recent tail forward. In my live torture test, total input fell `31%` with the answer intact.",
      "Monster command output is no longer a dead end. I save the full result for `48 hours` and point EZ Coder straight to the missing slice, so it can recover one buried line without rerunning the whole command or stuffing your context twice.",
    ],
  },
  {
    version: "0.23.1",
    ...
    items: [
      ...
      "`Autopilot` stopped double-checking itself. When Nolan reviews your work he now owns the whole verification, so runs finish faster with one clean verdict instead of two overlapping reviews.",
    ],
  },
  {
    version: "0.23.0",
  ...
  },
  {
    ...
    items: [
      ...
      "`Plan Steps` finally stays locked to the real plan while EZ Coder works. I made it follow live edits, count completed steps honestly, and disappear the instant the run ends, so stale progress never hangs around pretending work is still moving.",
  ...
  },
  {
    ...
    items: [
      ...
      "`Context` tracking got sharper across every route and model. I taught EZ Coder to use the right limits and timing evidence, so long sessions compact at the right moment instead of guessing.",
    ],
  },
  {
    version: "0.21.0",
    ...
    items: [
      ...
      "Beautiful interfaces are no longer a lucky roll. I bundled `Evidence-Led UI` into every install, so EZ Coder now checks real design craft, accessibility, and responsive behavior before it touches your frontend.",
  ...
  },
  {
    ...
    date: "2026-07-13",
    items: [
      "Chat just became a whole new side of EZ Coder. I built `General`, `Therapist`, and `Research` companions with their own conversation history, then gave them durable memory you can inspect and clean up anytime.",
  ...
  },
  {
    ...
    items: [
      ...
      "`Apple silicon` is cleaner and ready for what comes next. I stripped unused Intel baggage out of the app bundle, cutting roughly `180 MB` before compression and keeping EZ Coder fully native as macOS moves beyond Rosetta.",
    ],
  },
  {
    version: "0.18.1",
  ...
  },
  {
    ...
    items: [
      ...
      "`Radio` finally behaves like part of the app. I added a volume slider, made your level stick across windows, and guaranteed the music stops when EZ Coder closes, even after a force quit.",
  ...
  },
  {
    ...
    date: "2026-07-10",
    items: [
      "Apps you launch through EZ Coder can finally hear you. I unlocked microphone access for recorders, voice tools, and every other project you run, so testing audio now just works.",
    ],
  },
  {
    version: "0.15.0",
  ...
  },
  {
    ...
    date: "2026-07-06",
    items: [
      "Your session list is yours again. Nolan's silent autopilot reviews were quietly leaving behind a fake 2-message session every few minutes, burying your real work under a wall of clones. I plugged the leak for good, so what you see in the picker is exactly what you built. Nothing else.",
      "`Autopilot` got tougher to derail. I made Nolan's handoffs land even when they arrive wrapped in chatter, then tightened his reviews so cycles run leaner and stall less.",
    ],
  },
  {
    version: "0.14.8",
  ...
  },
  {
    ...
    date: "2026-07-05",
    items: [
      "Your machine breathes easier now. `EZ Coder` hunts down leftover built-in and custom tool helpers on startup, so closed projects stop quietly eating your memory for days.",
      "Nolan gives sharper advice. He now knows exactly what EZ Coder can do under the hood, so his guidance is grounded in the real tools at hand instead of guesses, and his handoffs back to the agent come through clean.",
    ],
  },
  {
    version: "0.14.6",
    date: "2026-07-05",
    items: [
      "`Autopilot` just got more independent. EZ Coder now proves its own work and handles the obvious safe next step without asking for a human who is not there, so more jobs finish in one run.",
    ],
  },
  {
    version: "0.14.5",
  ...
  },
  {
    ...
    items: [
      ...
      "I trimmed the instruction stack again. EZ Coder spends less attention on boilerplate and more attention on your code.",
    ],
  },
  {
    version: "0.14.2",
  ...
  },
  {
    ...
    items: [
      ...
      "I got better at spotting fake blockers. If EZ Coder asks permission for safe work that is already implied by your request, I tell it to keep going instead of dragging you back in.",
    ],
  },
  {
    version: "0.13.0",
  ...
  },
  {
    ...
    date: "2026-07-02",
    items: [
      "`Autopilot` is calmer and harder to fool. I judge EZ Coder against your original request, stop inventing work after the job is done, and call you in instead of answering real questions or plan decisions on your behalf.",
  ...
  },
  {
    ...
    date: "2026-07-02",
    items: [
      "Meet `Autopilot`. I review every finished job, send broken work straight back with a sharp fix, call clear work done, and tap you for real judgment calls, all while a live Nolan status and in-chat verdict show exactly what I am doing.",
  ...
  },
  {
    ...
    date: "2026-07-01",
    items: [
      "Rare empty tool calls from `Anthropic` no longer kill your session. EZ Coder quietly picks the work back up, and real failures now name the actual culprit instead of blaming itself.",
    ],
  },
  {
    version: "0.10.1",
  ...
  },
  {
    ...
    date: "2026-06-30",
    items: [
      "`@Nolan` is easier to remember and stays in sync. Helpful hints rotate into the input, and every model switch carries over so his advice comes from the same brain you chose for EZ Coder.",
    ],
  },
  {
    version: "0.7.0",
    date: "2026-06-30",
    items: [
      "Say hey to `@Nolan`, your research-first mentor inside the app. I check real code and live docs, challenge shaky plans, recommend tools with taste, turn advice into one-click `Send to EZ Coder` prompts, and keep our chats waiting for you after a restart.",
    ],
  },
  {
    version: "0.6.1",

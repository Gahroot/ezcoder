...
function App(): React.ReactElement {
  ...
  // "EZ Coder" (home/picker/login screens, and while the session picker is open).
  useEffect(() => {
    const inProject = !needsProject && !showPicker;
    setWindowTitle(inProject && sessionTitle ? sessionTitle : "EZ Coder");
    ...
    (e: SidecarEvent) => {
      ...
      switch (e.type) {
        ...
        case "run_end": {
          ...
          // Final response is in; exit the tool panel (mirrors ezcoder).
          setLiveToolFeed([]);
